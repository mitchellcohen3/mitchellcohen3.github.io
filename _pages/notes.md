...
<div class="container">
  <div class="row justify-content-center">
    ...
    <div class="col-md-8 mb-4">
      <div class="card shadow-sm">
        <div class="card-body">
          <h4 class="card-title">The Sliding Window Filter</h4>
          <p class="card-text">Derivation of a common optimization-based approach to real-time state estimation. (last updated: November 24th, 2025)</p>
          <a href="{{ site.baseurl }}/assets/pdf/notes/swf.pdf" class="btn btn-primary" target="_blank">
            View PDF
          </a>
        </div>
      </div>
